...
class config implements Configuration
{
	...
	const amazonSkillId = 'amzn1.ask.skill.013b5974-0e7a-4f9c-a41f-5f77bcf3b2cd,amzn1.ask.skill2.XXXXXXX';
	...
	// my constants here
	const applicationName = 'ALEXA-help';
	const applicationURL = 'https://endpoint.givemesite.com/Ready-Help-amazon-alexa_API/www/AmazonDev/';
	const applicationDomain = 'givemesite.com';
	const siteTitle='ALEXA-help';
